...
let activeIndex = 0;
const gameOptions:any = document.getElementsByClassName("game_option");
const background = document.getElementsByTagName("main")[0];
const mainBtn: any =  document.getElementById("game_mainBtn") != null? document.getElementById("game_mainBtn"): document.createElement("button");
